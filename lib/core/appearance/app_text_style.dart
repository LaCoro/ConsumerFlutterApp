...
class AppTextStyle {
  ...
  static TextStyle grey16overline = GoogleFonts.roboto(fontWeight: FontWeight.normal, fontSize: 16, color: Color(0xff868686),decoration: TextDecoration.lineThrough);//#resultados y sug busqueda
